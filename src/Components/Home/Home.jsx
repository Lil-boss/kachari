        ...
        <div>
            ...
            <div className='w-4/5 mx-auto mt-10 mb-3'>
                <div className='grid md:grid-cols-3 gap-5'>
                    ...
                    <div className='flex flex-wrap items-center'>
                        <h3 className='text-xl hover:text-orange-600'>Fight for Justice</h3>
                        ...
                        <h3 className='text-xl mt-6 hover:text-orange-600'>Most Experienced</h3>
                    ...
                    <div className='flex flex-wrap items-center'>
                        <h3 className='text-xl hover:text-orange-600'>Best Case Strategy</h3>
                        ...
                        <h3 className='text-xl mt-6 hover:text-orange-600'>Quick Case Solve</h3>
